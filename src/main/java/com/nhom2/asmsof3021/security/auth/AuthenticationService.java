...
import com.nhom2.asmsof3021.security.config.JwtService;
import com.nhom2.asmsof3021.security.token.Token;
import com.nhom2.asmsof3021.security.token.TokenRepository;
import com.nhom2.asmsof3021.security.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        if (!request.getPassword().equals(request.getConfirmPassword())){
            throw new IllegalArgumentException("deo trung password");
        }
